...
[work, part, inspector, soundPlayer, annotation, checkbox, updateNotification, splashScreen, flyoutMenu, flyoutMenuItem, workSelector].forEach(component => component.register());
